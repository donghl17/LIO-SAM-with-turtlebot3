...
void rviz_gmm::initVisual(ros::NodeHandle node_){
    gmm_sub_ = node_.subscribe<submap::gmm>("/subgmm", 1000, &rviz_gmm::gmmCallback, this);
...
void rviz_gmm::gmmCallback(const submap::gmm gmm){
  ...
  uint32_t shape = visualization_msgs::Marker::SPHERE;
    ...
    // std::cout<<"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"<<std::endl;
    marker.pose.position.x = gmm.x[0];
    marker.pose.position.y = gmm.y[0];
    marker.pose.position.z = gmm.z[0];
